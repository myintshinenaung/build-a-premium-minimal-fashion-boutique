import { defaultAdminHeroSettings, defaultStorefrontSettings } from "@/features/settings/domain/defaults";
import { resolveCmsContent, type Locale } from "@/features/i18n/server";
