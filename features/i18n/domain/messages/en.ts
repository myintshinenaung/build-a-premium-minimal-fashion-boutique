export const enMessages = {
  ...
  reviews: {
    ...
    verifiedPurchaseOnly: "Only customers with a verified purchase can submit a review.",
    ...
    submitted: "Thank you. Your review has been submitted for moderation.",
    loading: "Loading reviews…",
    empty: "No published reviews yet.",
    helpful: "Helpful ({count})",
    report: "Report",
    reportReason: "Reason for report",
    reportReasonRequired: "Please provide a reason for reporting this review.",
  ...
  shop: {
    ...
    searchError: "Unable to load search results.",
  ...
  checkout: {
    ...
    description: "Review your bag and enter delivery details to place your order.",
    ...
    township: "Township",
    notes: "Notes",
    notesPlaceholder: "Delivery instructions or order notes",
    shipping: "Shipping",
    ...
    couponError: "Unable to apply coupon. Please check the code and try again.",
    placeOrder: "Continue to payment",
    redirectingToPayment: "Redirecting to payment…",
    placingOrder: "Placing order…",
    submitError: "Unable to place order. Please check your details and try again.",
    ...
    confirmationDescription: "We received your order and will contact you to confirm delivery.",
